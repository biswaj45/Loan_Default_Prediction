...
@app.route('/')
def home():
    return render_template('home.html', form_data={}, prediction_text=None, error=None)
...
def predict():
    ...
    try:
        ...
        return render_template('home.html', prediction_text=f"The Default Prediction is: {prediction}", form_data=request.form, error=None)

    except ValidationError as e:
        return render_template('home.html', prediction_text="Invalid input data", form_data=request.form, error=e.errors())
